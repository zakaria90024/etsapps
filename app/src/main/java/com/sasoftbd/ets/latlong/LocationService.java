            ...
            client.requestLocationUpdates(request, new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    if (addressLocation.isEmpty()) {
                        ...
                        LocationPostModel locationPostModel = new LocationPostModel(getCurrentTime(), getCurrentTime(), "Travelling", "", fullAddress, String.valueOf(batteryInt) + "%", "", String.valueOf(latitude), String.valueOf(longitude), authPrefsDataClass.getUserName(), authPrefsDataClass.getCardNO(), authPrefsDataClass.getRole());
                        Gson gson = new Gson();
